...
def research_content():
    ...
    return f'<div class="research-overview"><div><p class="lead">{e(data["intro"])}</p><a class="text-link" href="#mechanism-to-prediction">Explore our research themes ↓</a></div><figure class="receptor-figure"><img src="assets/research_figure_receptor.png" alt="Molecular visualization of a receptor with protein helices, bound molecules, and highlighted sites" width="2675" height="3433" decoding="async"><figcaption>A molecular perspective on receptor structure and ligand interactions.</figcaption></figure></div><div class="prose research-themes">{themes}<h2>Open science and training</h2><p>Our research program emphasizes reproducible simulation and machine-learning workflows, open tools, and close collaboration with experimental researchers. We train students to formulate mechanistic questions, build reusable research infrastructure, and communicate across disciplines.</p><p>Our training and education activities connect with the <a class="text-link" href="{CPDSE_URL}">Center for Pharmaceutical Data Science Education (CPDSE)</a>.</p><a class="text-link" href="{e(data["github"])}">Explore our GitHub ↗</a></div>'
...
<header class="container header"><a class="brand" href="index.html" aria-label="MD³ Group home"><img class="brand-lockup" src="assets/md3-name-transparent.png" width="1772" height="888" alt="MD³ Group — Mechanistic Drug Design and Discovery"></a>
